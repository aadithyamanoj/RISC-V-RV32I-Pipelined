...
VL_INLINE_OPT void Vtop_riscv_multicycle___nba_sequent__TOP__top__core__core__0(Vtop_riscv_multicycle* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_riscv_multicycle___nba_sequent__TOP__top__core__core__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ __Vdly__instruction_count;
    __Vdly__instruction_count = 0;
    IData/*31:0*/ __Vdly__current_stage;
    __Vdly__current_stage = 0;
    IData/*31:0*/ __VdlyVal__reg_file__v0;
    __VdlyVal__reg_file__v0 = 0;
    CData/*4:0*/ __VdlyDim0__reg_file__v0;
    __VdlyDim0__reg_file__v0 = 0;
    CData/*0:0*/ __VdlySet__reg_file__v0;
    __VdlySet__reg_file__v0 = 0;
    // Body
    __Vdly__instruction_count = vlSelfRef.instruction_count;
    __VdlySet__reg_file__v0 = 0U;
    __Vdly__current_stage = vlSelfRef.__PVT__current_stage;
    if (vlSymsp->TOP.reset) {
        __Vdly__instruction_count = 0U;
        __Vdly__current_stage = 0U;
        vlSelfRef.__PVT__pc = 0x10000U;
    } else {
        if ((4U == vlSelfRef.__PVT__current_stage)) {
            __Vdly__instruction_count = ((IData)(1U) 
                                         + vlSelfRef.instruction_count);
            vlSelfRef.__PVT__pc = vlSelfRef.__PVT__next_pc;
        }
        if ((0U == vlSelfRef.__PVT__current_stage)) {
            if ((0x80000U & vlSymsp->TOP__top.__PVT__inst_mem_rsp[0U])) {
                __Vdly__current_stage = 1U;
            }
        } else if ((1U == vlSelfRef.__PVT__current_stage)) {
            __Vdly__current_stage = 2U;
        } else if ((2U == vlSelfRef.__PVT__current_stage)) {
            __Vdly__current_stage = 3U;
        } else if ((3U == vlSelfRef.__PVT__current_stage)) {
            __Vdly__current_stage = 4U;
        } else if ((4U == vlSelfRef.__PVT__current_stage)) {
            if (vlSelfRef.__PVT__memory_stage_complete) {
                __Vdly__current_stage = 0U;
            }
        } else {
            __Vdly__current_stage = 0U;
    ...
    if ((1U & (~ (IData)(vlSelfRef.__PVT__read_reg_valid)))) {
        if (vlSelfRef.__PVT__write_reg_valid) {
            __VdlyVal__reg_file__v0 = vlSelfRef.__PVT__wbd;
            __VdlyDim0__reg_file__v0 = vlSelfRef.__PVT__wbs;
            __VdlySet__reg_file__v0 = 1U;
        }
    }
    if ((2U == vlSelfRef.__PVT__current_stage)) {
        vlSelfRef.__PVT__exec_result = (IData)(vlSelfRef.__PVT__exec_result_comb);
        vlSelfRef.__PVT__next_pc = vlSelfRef.__PVT__next_pc_comb;
    }
    if ((0x80000U & vlSymsp->TOP__top.__PVT__data_mem_rsp[0U])) {
        vlSelfRef.__PVT__load_result = ((vlSymsp->TOP__top.__PVT__data_mem_rsp[1U] 
                                         << 0xcU) | 
                                        (vlSymsp->TOP__top.__PVT__data_mem_rsp[0U] 
                                         >> 0x14U));
    }
    if (vlSelfRef.__PVT__read_reg_valid) {
        vlSelfRef.__PVT__reg_file_rd1 = vlSelfRef.__PVT__reg_file
            [vlSelfRef.__PVT__rs1];
        vlSelfRef.__PVT__reg_file_rd2 = vlSelfRef.__PVT__reg_file
            [vlSelfRef.__PVT__rs2];
    }
    if ((0x80000U & vlSymsp->TOP__top.__PVT__inst_mem_rsp[0U])) {
        vlSelfRef.__PVT__latched_instruction_read = 
            ((vlSymsp->TOP__top.__PVT__inst_mem_rsp[1U] 
              << 0xcU) | (vlSymsp->TOP__top.__PVT__inst_mem_rsp[0U] 
                          >> 0x14U));
    }
    vlSelfRef.instruction_count = __Vdly__instruction_count;
    if (__VdlySet__reg_file__v0) {
        vlSelfRef.__PVT__reg_file[__VdlyDim0__reg_file__v0] 
            = __VdlyVal__reg_file__v0;
    }
    vlSelfRef.__PVT__current_stage = __Vdly__current_stage;
...
VL_INLINE_OPT void Vtop_riscv_multicycle___nba_sequent__TOP__top__core__core__1(Vtop_riscv_multicycle* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_riscv_multicycle___nba_sequent__TOP__top__core__core__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
