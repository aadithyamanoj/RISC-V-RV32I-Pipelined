...
VL_ATTR_COLD void Vtop___024root___eval_stl(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        ...
        Vtop_riscv_multicycle___stl_sequent__TOP__top__core__core__0((&vlSymsp->TOP__top__core__core));
        Vtop_clean_core___stl_sequent__TOP__top__core__0((&vlSymsp->TOP__top__core));
    }
}
